...
import { LayoutDashboard, TrendingUp, Users, MessageSquare, Package, ArrowUpRight, ArrowDownRight, MoreHorizontal, ShoppingCart, Star, Clock } from 'lucide-react';
                  ...
                  {topProducts.map((p, idx) => (
                    <div key={p.id} className="flex items-center justify-between group">
                       <div className="flex items-center gap-4">
                          <span className="text-xs font-black text-zinc-300 w-4">0{idx + 1}</span>
