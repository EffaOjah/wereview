...
const ReviewSubmissionModal: React.FC<ReviewSubmissionModalProps> = ({ isOpen, onClose, GadgetName, initialData, onSubmit, isSubmitting }) => {
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl z-10 flex flex-col my-auto max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 border-t border-zinc-100 flex justify-end gap-4 flex-shrink-0 bg-white">
          ...
          <button 
            ...
            className="px-8 py-2.5 rounded-lg font-bold bg-primary text-white hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-primary/30 min-w-[140px] flex items-center justify-center"
          >
            {isSubmitting ? (
